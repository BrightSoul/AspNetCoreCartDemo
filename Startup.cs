...
namespace AspNetCoreCartDemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.IdleTimeout = TimeSpan.FromMinutes(1); // Configure session expiration for inactivity
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles();
            app.UseSession(); // Use the session middleware here
